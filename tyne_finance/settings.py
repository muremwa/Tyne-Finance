"""
Django's settings for tyne_finance project.
...
from .loader import load_variables

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent
env_variables = load_variables()
...
ROOT_URLCONF = 'tyne_finance.urls'
...
WSGI_APPLICATION = 'tyne_finance.wsgi.application'
