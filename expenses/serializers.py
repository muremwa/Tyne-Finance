...
from rest_framework.fields import IntegerField, empty

from core.serializers import NoEditOrCreateModelSerializer, ModelSerializerRequiredFalsifiable, AccountSerializer
...
class ExpenseSerializer(ModelSerializerRequiredFalsifiable):
